...
| Radicle | Source-inspected mapping, disposable local/private CLI replay evidence, one disposable public seed/remote-clone smoke for exact RID `rad:z2WtozFrCRhygh9CGzyUN57CN7Nwa`, current-host route probes, and a project-scoped Radicle repo smoke for RID `rad:zWGy1Ssjb7tBbwDbdGLqeHCsUqwr` with separate-profile clone/readback at commit `fd3f1898d81a4b00be9095c62e3c07fc1a792a95` | Persistent seed operation, broad Radicle network availability, durability, identity trust, production readiness |
