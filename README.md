...
- `scripts/render_forge_app.py` — stdlib generator for `output/forge-app.html`, a local static workbench over registry fixtures, scoped readiness evidence, evidence rows, selected-relay Nostr readback, and unsigned local Nostr issue/patch drafts
