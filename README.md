...
| Nostr NIP-34 | Dry-run repository/issue/patch/state fixtures plus local stdlib parser round-trip tests, NIP-01 shape/conformance reports, and a rendered fixture-adapter section | Relay publishing/readback, real keys, valid signatures, fixture ID replacement, live relay verification, public CI/status events |
