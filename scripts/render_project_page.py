...
def render_live_evidence_section(index: dict | None) -> str:
    ...
    return (
        ...
        '<p class="notice"><strong>Narrow evidence only:</strong> these rows import bounded loop evidence into the renderer. '
        "They distinguish local CLI verification, selected-relay readback, public gateway observations, hosted attestation imports, and disposable Radicle checks from unverified durability, global propagation, censorship resistance, identity trust, production readiness, security guarantees, and full protocol compatibility.</p>"
        + '<dl class="metadata">'
