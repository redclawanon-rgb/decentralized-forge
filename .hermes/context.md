...
Current override after Loop 73: A second persistent follower seed is staged on `ubuntu-work` with separate Radicle state and node ID `z6MksRdjzuN2VYV4HTXdVSchitJ8Bq1zbx8WhBb3KhyfSm6A`, listening on Tailnet address `100.83.206.66:8877`. A fresh `openclaw` reader cloned retained RID `rad:z3Q8ePG6Qs4PQi1SWf9BEzDayENcy` from that Tailnet seed and verified commit `ef16e2ad39d3e13bdcc9d454443c5bbb17733c68`. Evidence is `evidence/radicle-ubuntu-work-follower-bootstrap-2026-06-29.json` and `evidence/radicle-second-seed-tailnet-health-2026-06-29.json`; live evidence index is loop 73. This is not a second public internet seed yet. Opening an `openclaw` public relay on port `8877` is security-relevant and requires explicit approval before installation.

Current override after Loop 74: The second follower seed is now verified through a public direct-seed address. `openclaw` runs `decentralized-forge-radicle-mirror-public-relay.service` on public TCP `8877`, relaying to `ubuntu-work` Tailnet `100.83.206.66:8877`. A fresh `ubuntu-work` reader connected to `z6MksRdjzuN2VYV4HTXdVSchitJ8Bq1zbx8WhBb3KhyfSm6A@187.77.19.162:8877`, cloned retained RID `rad:z3Q8ePG6Qs4PQi1SWf9BEzDayENcy`, and verified commit `ef16e2ad39d3e13bdcc9d454443c5bbb17733c68`. Evidence is `evidence/radicle-second-public-seed-health-2026-06-29.json`; live evidence index is loop 74. Do not claim independent provider/network availability because public ingress still uses `openclaw`.
